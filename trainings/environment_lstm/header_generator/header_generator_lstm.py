"""
Script: header_generator_lstm.py
Module role:
    Convert the latest quantized LSTM TensorFlow Lite artifact into a C/C++
...
# -----------------------------------------------------------------
from utils.global_utils.paths_lstm import PROJECT_ROOT, QUANTIZED_MODEL, HEADER_GENERATOR  # uses the project root in a stable manner
...
convert_tflite_to_header(
    tflite_model_path= version_path/"environment_quantized_model_lstm.tflite",
    output_header_path=run_dir/"environment_model_data_lstm.h",
    variable_name="environment_model"
)

print("[INFO] Generated file: environment_model_data_lstm.h")
