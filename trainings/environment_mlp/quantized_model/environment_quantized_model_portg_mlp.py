    ...
    try:
        ...
        try:
            ...
            if x_dt.isna().all():
                ...
                plt.xlabel("Rolling-24 window index")
            else:
                ax = plt.gca()
        ...
        plt.title("Quantized MLP: Rolling-24 for indoor temperature")
        plt.grid(True, linestyle="--", alpha=0.5)
        plt.legend()
        plt.tight_layout()
        ...
        plt.title("Quantized MLP: Rolling-24 for indoor humidity")
        plt.grid(True, linestyle="--", alpha=0.5)
        plt.legend()
        plt.tight_layout()
...
plt.title("Quantized MLP: loss during QAT — "f"training-validation difference = {gap_pct:.2f}%")
plt.xlabel("Epoch")
plt.ylabel("MSE loss")
plt.legend()
plt.grid(True, linestyle="--", alpha=0.5)
...
plt.title("Quantized MLP: indoor temperature — ground truth vs prediction")
plt.grid(True, linestyle="--", alpha=0.5)
plt.tight_layout()
...
plt.title("Quantized MLP: indoor humidity — ground truth vs prediction")
plt.grid(True, linestyle="--", alpha=0.5)
plt.tight_layout()
