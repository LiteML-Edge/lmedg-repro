...
def resolve_runtime_paths(
    ...
    if cli_out:
        ...
        preferred = (
            ...
            / platform_slug
            / mode_slug
            / f"model_io_comparison_mlp_{platform_slug}_{mode_slug}.xlsx"
        )
...
def build_human_summary(
    ...
    if input_status != "MATCH":
        conclusion = "The critical model input tensor still diverges; fix input packaging before interpreting any MLP output mismatch."
        interpretation = (
