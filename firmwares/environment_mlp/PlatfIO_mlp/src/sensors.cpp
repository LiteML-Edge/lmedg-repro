...
#if USE_DHT22
  #include <DHT.h>
  static DHT dht_out(PIN_DHT_OUT, DHTTYPE, 30);
  static DHT dht_in (PIN_DHT_IN,  DHTTYPE, 30);
#endif
...
#if __has_include("environment_quantized_samples_replay_raw_2plus47_mlp.h")
  #include "environment_quantized_samples_replay_raw_2plus47_mlp.h"
#endif
