# LiteML-Edge Firmware — Conv1D Tiny

This PlatformIO project deploys the Conv1D Tiny model on:

- WEMOS LOLIN32 / ESP-WROOM-32: `lolin32_Conv1D_Tiny`
- NUCLEO-F411RE / STM32F411RE: `nucleo_f411re_Conv1D_Tiny`
...
```powershell
pio run -d firmwares/environment_Conv1D_Tiny/PlatfIO_Conv1D_Tiny -e lolin32_Conv1D_Tiny
pio run -d firmwares/environment_Conv1D_Tiny/PlatfIO_Conv1D_Tiny -e nucleo_f411re_Conv1D_Tiny
```
...
```powershell
python utils/global_utils/pio_monitor.py -d firmwares/environment_Conv1D_Tiny/PlatfIO_Conv1D_Tiny -e lolin32_Conv1D_Tiny --port COM6 --baud 115200 --wait 20
python utils/global_utils/pio_monitor.py -d firmwares/environment_Conv1D_Tiny/PlatfIO_Conv1D_Tiny -e nucleo_f411re_Conv1D_Tiny --port COM8 --baud 115200 --wait 20
```
